package com.gradle.multimodule.reactivewebflux.router;

import com.gradle.multimodule.reactivewebflux.handler.SampleHandlerFunction;
...
public class RouterFunctionConfig {
    ...
    public RouterFunction<ServerResponse> routerFunction(SampleHandlerFunction handlerFunction){
        System.out.println("calling  through router function...");
